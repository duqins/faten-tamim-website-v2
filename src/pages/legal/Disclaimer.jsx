...
export default function Disclaimer() {
  ...
  const content = isAr ? {
    ...
    sections: [
      ...
      { heading: '7. حدود التزاماتنا', text: 'لن يكون مكتب الدكتوره فاتن تميم للمحاماه والاستشارات القانونية مسؤولًا عن أي خسارة أو ضرر ينشأ عن استخدام هذا الموقع أو الاعتماد على المعلومات الواردة فيه. يشمل ذلك الأضرار غير المباشرة أو التبعية أو الخاصة أو العقابية.' },
    ],
  } : {
    title: 'Disclaimer',
