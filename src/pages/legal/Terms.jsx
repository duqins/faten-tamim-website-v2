...
export default function Terms() {
  ...
  const content = isAr ? {
    ...
    sections: [
      ...
      { heading: '5. الملكية الفكرية', text: 'جميع المحتويات الواردة في هذا الموقع — بما في ذلك النصوص والصور والشعارات والتصميم — هي ملك لمكتب الدكتوره فاتن تميم للمحاماه والاستشارات القانونية أو مرخصة له، وتخضع لحماية قوانين حقوق الملكية الفكرية. يُحظر نسخ أي محتوى أو إعادة إنتاجه أو توزيعه أو تعديله دون الحصول على إذن كتابي مسبق منّا.' },
      ...
      { heading: '8. تحديد المسؤولية', text: 'إلى أقصى حد يسمح به القانون المنطبق، لن يكون مكتب الدكتوره فاتن تميم للمحاماه والاستشارات القانونية وشركاؤه وموظفوه مسؤولين عن أي أضرار مباشرة أو غير مباشرة أو عرضية أو خاصة أو عقابية أو تبعية ناشئة عن استخدامك لهذا الموقع أو عدم قدرتك على استخدامه.' },
